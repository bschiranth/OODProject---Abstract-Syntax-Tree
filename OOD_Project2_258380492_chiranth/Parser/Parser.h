...
class Parser;
////////////////////////////////////////////////////////////////
class IBuilder // has a abstract build function
{
public:
  virtual ~IBuilder() {}
...
class IAction // has abstract doAction function
{
public:
  virtual ~IAction() {}
...
public:
  virtual ~IRule() {}
  void addAction(IAction* pAction); // adds action 
  void doActions(ITokCollection*& pTc);
  virtual bool doTest(ITokCollection*& pTc)=0;
protected:
  std::vector<IAction*> actions; // vector of IAction pointers
};
////////////////////////////////////////////////////////////////
class Parser
{
...
private:
  ...
  std::vector<IRule*> rules; // vector of IRule pointers 
};
